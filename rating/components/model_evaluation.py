...
from rating.entity import config_entity, artifact_entity
...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self) -> artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            # transformed_predictions = target_encoder.inverse_transform(y_pred)
            # print(f"Prediction using previous model: {transformed_predictions[:5]}")
            ...
            # transformed_current_predection = current_target_encoder.inverse_transform(y_pred)
            # y_true =current_target_encoder.transform(target_df)
            # print(f"Prediction using trained model: {transformed_current_predection[:5]}")
